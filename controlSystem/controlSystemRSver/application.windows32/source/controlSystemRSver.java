...
public class controlSystemRSver extends PApplet {
...
public void drawTitle(int back, int fill) {
  background(back);
...
public void sendSerial() {
  ...
  switch(PApplet.parseInt(abs(x1))) {
  case 33:
    serialData |= 0x01;
    break;
  case 66:
  ...
  switch(PApplet.parseInt(abs(y1))) {
  case 33:
    serialData |= 0x08;
    break;
  case 66:
...
public void xbox(int[] Controlers) {
  try {
    ControlIO control;
...
public void drawDeviceNum(int devNum) {
  if (devNum>=0) {
    if (slave==num) {
...
public void drawControlerStatus(int[] Controlers, int NUM) {
  ...
  x1 = (PApplet.parseInt(x1*3)/3.0f)*100;
  y1 = (PApplet.parseInt(y1*3)/3.0f)*100;
...
public void keyReleased() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "controlSystemRSver" };
    if (passedArgs != null) {
